...
* CVE-2021-45105 Detail [https://nvd.nist.gov/vuln/detail/CVE-2021-45105](https://nvd.nist.gov/vuln/detail/CVE-2021-45105).  Apache Log4j2 versions 2.0-alpha1 through 2.16.0 (excluding 2.12.3) are vulnerable to a denial of service attack because they did not protect against uncontrolled recursion from self-referential lookups, attackers with control over Thread Context Map (MDC) input data can craft malicious input data that contains a recursive lookup, resulting in a StackOverflowError that will terminate the process.  Denial of service is often scored as a lower risk vulnerability -- this being CVSSv3 or v2 of 7.5.  

...
With [Senate File 2340]() the Iowa Legislature and Governor created a new crime of "illegal reentry."  It says that anyone who has previously been deported, removed or denied admission to the United States and then enters Iowa, can be sent to prison in Iowa for up to 10 years and the judge in the case would have to order the convicted person to return to "the country they had come from."  

While the new law says law enforcement officers can't arrest someone if that individual is in a school, a place of worship, a health care facility, or a facility for survivors of sexual assault, it also provides legal immunity for local law enforcement and other government officials responsible for enforcing the measure. That immunity appears to support behaviors that make Iowa an unwelcoming place for all who do not emit the visual and audio queues that signal "Iowan" to state and local officials (*strongly suspect that means, for too many, "white without an accent"*).  

...
Reference table of musical note frequencies in Hertz ([Hz](https://en.wikipedia.org/wiki/Hertz)).  
The top row is the [octave](https://en.wikipedia.org/wiki/Octave) (from 0 to 8).  
...
Hertz (Hz) values from [muted.io](https://muted.io/note-frequencies/)  
...
|Guitar |80 Hz – 5 kHz |
|Piano  |27.5 Hz – 4 kHz |
|Concert Ukulele |196 Hz - 1.76 kHz |
|Baritone Ukulele | 146.83 Hz - 1.32 kHz |

These are approximate ranges for common tunings...
...
* For some recent CO2 measurement documentation, see: "[Hawaii’s Mauna Loa Observatory just captured ominous signals about the planet’s health -- Carbon dioxide is accumulating in the atmosphere faster than ever](https://www.washingtonpost.com/weather/2024/05/10/carbon-dioxide-record-mauna-loa/)." By Scott Dance,  May 10, 2024.  
...
Another example is Trump 47 and his team have been reversing the fuel mileage standards on cars and *light trucks* (includes SUVs) so that by September 2026 fleets needed only reach an average of 34 miles per gallon.  The U.S. national standard was heading to 50 MPG.  A 34 mpg standard versus a 50 mpg standard would increase annual carbon emissions from the U.S. light-duty fleet by roughly 150–200 million metric tons of CO₂, assuming the same vehicle miles traveled and fleet mix. Ugg...
